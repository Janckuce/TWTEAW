...
NDefines.NGame.GAME_SPEED_SECONDS = { 2.0, 0.5, 0.15, 0.04, 0.0 } -- game speeds for each level. Must be 5 entries with last one 0 for unbound
...
Central-Powers-Final-Update-Branch-Please-No-More
